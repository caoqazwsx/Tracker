...
public class Weather {
    ...
    private String status1;//日间天气
    private String status2;//晚间天气
    private String figure11;//日间天气（拼音）
    private String figure12;//晚间天气（拼音）
    private String direction1;//日间风向
    private String direction2;//晚间风向
    private String power1;//日间风力
    private String power2;//晚间风力
    private String temperature1;//日间气温
    private String temperature2;//晚间气温
    private String ssd;
    private String tgd1;
    private String tgd2;
    private String zwx;
    ...
    public String getFigure11() {
        return figure11;
    }

    public void setFigure11(String figure11) {
        this.figure11 = figure11;
    }

    public String getFigure12() {
        return figure12;
    }

    public void setFigure12(String figure12) {
